...
export class UserView extends ViewV2 {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda, extraInfo) {
        ...
        this.userModel = {
            name: { "id": 83886102, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" },
            ...
            if (deviceInfo.distributionOSApiVersion >= CommonConstants.API_VERSION_23 &&
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        HdsNavDestination.create(() => {
                            ...
                            Column.pop();
                            Scroll.pop();
                        }, { moduleName: "multidevicecommunicationpcsample", pagePath: "features/user/src/main/ets/view/UserView" });
                        HdsNavDestination.titleBar(this.hdsTitleBar);
                        HdsNavDestination.backgroundColor({ "id": 83886148, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        NavDestination.backgroundColor({ "id": 83886148, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
    ...
    User(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 83886166, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Image.width(24);
            Image.height(24);
            Image.margin({ right: 24 });
            Image.fillColor({ "id": 83886144, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 83886168, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Image.width(24);
            Image.height(24);
            Image.margin({ right: 24 });
            Image.fillColor({ "id": 83886144, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 83886163, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Image.width(24);
            Image.height(24);
            Image.fillColor({ "id": 83886144, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.height('1px');
            Divider.backgroundColor({ "id": 83886133, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Divider);
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 83886116, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Text.fontSize(16);
            Text.lineHeight(21);
