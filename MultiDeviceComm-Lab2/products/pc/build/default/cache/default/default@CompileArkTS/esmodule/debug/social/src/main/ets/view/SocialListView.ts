...
export class SocialView extends ViewV2 {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 83886172, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Image.width(40);
            Image.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontColor({ "id": 83886146, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.fontColor({ "id": 83886145, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Text.margin({ top: 2 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.backgroundColor({ "id": 83886130, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125831713, "type": 40000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, SymbolGlyph);
        Column.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            SymbolGlyph.create({ "id": 125831544, "type": 40000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            SymbolGlyph.width(18);
            SymbolGlyph.height(18);
            SymbolGlyph.fontColor([{ "id": 83886145, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" }]);
        }, SymbolGlyph);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 83886121, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Text.fontSize(14);
            Text.lineHeight(17);
            Text.fontWeight(FontWeight.Regular);
            Text.fontColor({ "id": 83886146, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.width('100%');
            Row.height('1px');
            Row.backgroundColor({ "id": 83886143, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Row.margin({ top: 8 });
        }, Row);
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 83886120, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Text.fontSize(14);
            Text.lineHeight(17);
            Text.fontWeight(FontWeight.Regular);
            Text.fontColor({ "id": 83886146, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
