...
export class MessagesCommonView extends ViewV2 {
    ...
    aboutToAppear(): void {
        ...
        if (deviceInfo.distributionOSApiVersion >= 60100) {
            this.hdsTitleBar = {
                ...
                content: {
                    title: {
                        mainTitle: { "id": 67108887, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                    },
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        HdsNavDestination.create(() => {
                            ...
                            Column.pop();
                            Scroll.pop();
                        }, { moduleName: "multidevicecommunicationdefaultsample", pagePath: "features/commonui/src/main/ets/view/MessagesCommonView" });
    ...
    TitleBuilder(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 67108887, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
            ...
            if (this.moduleName === CommonConstants.DEVICE_TYPE_PC) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new GlassCircle(this, { imageSrc: { "id": 67108951, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" } }, undefined, elmtId, () => { }, { page: "features/commonui/src/main/ets/view/MessagesCommonView.ets", line: 188, col: 9 });
                                ViewV2.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new GlassCircle(this, { imageSrc: { "id": 67108945, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" } }, undefined, elmtId, () => { }, { page: "features/commonui/src/main/ets/view/MessagesCommonView.ets", line: 190, col: 9 });
                                ViewV2.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        imageSrc: { "id": 67108945, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                    };
                                };
                                componentCall.paramsGenerator_ = paramsLambda;
                            }
