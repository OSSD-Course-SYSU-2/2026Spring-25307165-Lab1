...
export class TextIcon extends ViewV2 {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda, extraInfo) {
        ...
        this.initParam("fontSize", (params && "fontSize" in params) ? params.fontSize : { "id": 125830971, "type": 10002, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
        this.initParam("fontColor", (params && "fontColor" in params) ? params.fontColor : { "id": 125830987, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
        this.initParam("fontWeight", (params && "fontWeight" in params) ? params.fontWeight : { "id": 125830955, "type": 10002, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
    ...
    public resetStateVarsOnReuse(params: Object): void {
        ...
        this.resetParam("fontSize", (params && "fontSize" in params) ? params.fontSize : { "id": 125830971, "type": 10002, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
        this.resetParam("fontColor", (params && "fontColor" in params) ? params.fontColor : { "id": 125830987, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
        this.resetParam("fontWeight", (params && "fontWeight" in params) ? params.fontWeight : { "id": 125830955, "type": 10002, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
