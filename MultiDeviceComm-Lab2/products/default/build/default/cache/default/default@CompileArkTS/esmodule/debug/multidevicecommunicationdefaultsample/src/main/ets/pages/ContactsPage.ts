    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new ContactsCommonView(this, { activeIndex: this.activeIndex }, undefined, elmtId, () => { }, { page: "products/default/src/main/ets/pages/ContactsPage.ets", line: 23, col: 5 });
...
export function ContactsPageBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new ContactsPage(parent ? parent : this, { activeIndex: CommonConstants.TAB_CONTACT_INDEX }, undefined, elmtId, () => { }, { page: "products/default/src/main/ets/pages/ContactsPage.ets", line: 29, col: 3 });
                ViewV2.create(componentCall);
                let paramsLambda = () => {
                    return {
