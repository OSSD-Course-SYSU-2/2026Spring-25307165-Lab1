...
export class ContactListView extends ViewV2 {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.backgroundColor({ "id": 83886129, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
    ...
    topSearch(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.backgroundColor({ "id": 83886131, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 83886118, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            Text.margin({ left: 8 });
            Text.fontSize(16);
            Text.lineHeight(21);
            Text.fontWeight(FontWeight.Regular);
            Text.fontColor({ "id": 83886137, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
        }, Text);
        Text.pop();
        Row.pop();
    }
    ...
    alphabetIndex(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            AlphabetIndexer.selectedColor({ "id": 83886128, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
            AlphabetIndexer.selectedBackgroundColor({ "id": 83886142, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
