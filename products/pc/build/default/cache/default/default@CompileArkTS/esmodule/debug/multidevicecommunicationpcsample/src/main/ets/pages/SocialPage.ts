    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new SocialCommonView(this, { activeIndex: this.activeIndex }, undefined, elmtId, () => { }, { page: "products/pc/src/main/ets/pages/SocialPage.ets", line: 23, col: 5 });
...
export function SocialPageBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new SocialPage(parent ? parent : this, { activeIndex: CommonConstants.TAB_SOCIAL_INDEX }, undefined, elmtId, () => { }, { page: "products/pc/src/main/ets/pages/SocialPage.ets", line: 29, col: 3 });
                ViewV2.create(componentCall);
                let paramsLambda = () => {
                    return {
