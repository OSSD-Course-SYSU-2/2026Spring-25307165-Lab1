    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new MineCommonView(this, { activeIndex: this.activeIndex }, undefined, elmtId, () => { }, { page: "products/pc/src/main/ets/pages/MinePage.ets", line: 23, col: 5 });
...
export function MinePageBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new MinePage(parent ? parent : this, { activeIndex: CommonConstants.TAB_MINE_INDEX }, undefined, elmtId, () => { }, { page: "products/pc/src/main/ets/pages/MinePage.ets", line: 29, col: 3 });
                ViewV2.create(componentCall);
                let paramsLambda = () => {
                    return {
