...
export class SocialCommonView extends ViewV2 {
    ...
    aboutToAppear(): void {
        ...
        if (deviceInfo.distributionOSApiVersion >= 60100) {
            this.hdsTitleBar = {
                ...
                content: {
                    title: {
                        mainTitle: { "id": 83886104, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" }
                    },
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        HdsNavDestination.create(() => {
                            ...
                            Column.pop();
                            Scroll.pop();
                        }, { moduleName: "multidevicecommunicationpcsample", pagePath: "features/commonui/src/main/ets/view/SocialCommonView" });
    ...
    TitleBuilder(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 83886104, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationpcsample" });
