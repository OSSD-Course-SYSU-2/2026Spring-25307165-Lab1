    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new MessagesCommonView(this, { activeIndex: this.activeIndex }, undefined, elmtId, () => { }, { page: "products/default/src/main/ets/pages/MessagesPage.ets", line: 23, col: 5 });
...
export function MessagesPageBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new MessagesPage(parent ? parent : this, { activeIndex: CommonConstants.TAB_MESSAGE_INDEX }, undefined, elmtId, () => { }, { page: "products/default/src/main/ets/pages/MessagesPage.ets", line: 29, col: 3 });
                ViewV2.create(componentCall);
                let paramsLambda = () => {
                    return {
