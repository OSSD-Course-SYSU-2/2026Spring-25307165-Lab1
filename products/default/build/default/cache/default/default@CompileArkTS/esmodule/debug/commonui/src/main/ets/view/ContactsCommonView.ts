...
export class ContactsCommonView extends ViewV2 {
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        HdsNavDestination.create(() => {
                            ...
                            Column.pop();
                            Scroll.pop();
                        }, { moduleName: "multidevicecommunicationdefaultsample", pagePath: "features/commonui/src/main/ets/view/ContactsCommonView" });
                        HdsNavDestination.titleBar({
                            content: {
                                title: {
                                    mainTitle: { "id": 67108876, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                },
                                ...
                                menu: {
                                    value: this.breakpoint.widthBreakpoint === WidthBreakpoint.WIDTH_SM &&
                                        ...
                                        {
                                            content: {
                                                icon: { "id": 67108951, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                            }
                                        },
                                        {
                                            content: {
                                                icon: { "id": 67108945, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                            }
                                        },
                                        {
                                            content: {
    ...
    TitleBuilder(parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 67108876, "type": 10003, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
            ...
            if (this.breakpoint.widthBreakpoint === WidthBreakpoint.WIDTH_SM &&
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new GlassCircle(this, { imageSrc: { "id": 67108951, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" } }, undefined, elmtId, () => { }, { page: "features/commonui/src/main/ets/view/ContactsCommonView.ets", line: 180, col: 9 });
                                ViewV2.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        imageSrc: { "id": 67108951, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                    };
                                };
                                componentCall.paramsGenerator_ = paramsLambda;
                            }
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.moduleName === CommonConstants.DEVICE_TYPE_PC) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 67108959, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" });
                        Image.width(24);
                        Image.height(24);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new GlassCircle(this, { imageSrc: { "id": 67108959, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" } }, undefined, elmtId, () => { }, { page: "features/commonui/src/main/ets/view/ContactsCommonView.ets", line: 195, col: 9 });
                                ViewV2.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        imageSrc: { "id": 67108959, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" }
                                    };
                                };
                                componentCall.paramsGenerator_ = paramsLambda;
                            }
                    ...
                    }, __Common__);
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new GlassCircle(this, { imageSrc: { "id": 67108949, "type": 20000, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" } }, undefined, elmtId, () => { }, { page: "features/commonui/src/main/ets/view/ContactsCommonView.ets", line: 197, col: 9 });
                                ViewV2.create(componentCall);
                                let paramsLambda = () => {
                                    return {
