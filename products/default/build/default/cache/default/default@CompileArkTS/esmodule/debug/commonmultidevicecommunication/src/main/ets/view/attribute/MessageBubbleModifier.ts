...
export class MessageBubbleModifier implements AttributeModifier<ColumnAttribute> {
    ...
    applyNormalAttribute(instance: ColumnAttribute): void {
        instance
            .height('100%')
            .margin({ left: 8 })
            .backgroundColor({ "id": 67108924, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" })
            .border({
            radius: {
                topLeft: 2,
                topRight: 24,
        ...
        if (this.type === CommonConstants.MESSAGE_BUBBLE_STYLE_3) {
            instance
                .width(164)
                .backgroundColor({ "id": 67108912, "type": 10001, params: [], "bundleName": "com.example.multidevicecommunication", "moduleName": "multidevicecommunicationdefaultsample" })
